import { NoPublicMenuMailParams } from "../../service/mailer.service";
import config from 'config'
const frontendUrl = config.get('frontendUrl') as string


export const NoPublicMenuNotificationTemplate = (input: NoPublicMenuMailParams) => {
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                        <tr>
                            <td>
                                ...
                                <p>Hope you're enjoying Scanserve.</p>
                                
                                <p>We are sending this message because someone has attempted to access one of your public pages (<strong>${input.storefrontUrl}</strong> or <strong>${input.pricesUrl}</strong>) and didn't find a public price card.</p>
                                
                                <p>You can expose one of your available price cards to the public or create a new one for the public. Do this by clicking on the checkbox that says "Check this box to use this price card online for your pubic customers" when creating or updating any of your price cards.</p>
                                ...
                                <p>Thanks and keep scaling with Scanserve 🚀</p>
